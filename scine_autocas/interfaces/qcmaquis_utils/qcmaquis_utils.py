...
from .qcmaquis_hdf5_utils import Hdf5Converter
from .qcmaquis_orbital_rdm_builder import OrbitalRDMBuilder
...
class QcmaquisUtils:
    ...
    def make_diagnostics(self):
        ...
        s1_entropy = self.s1_entropy[sort_key]
        self.s1_entropy = s1_entropy
        s2_entropy = self.s2_entropy[sort_key][:, sort_key]
        self.s2_entropy = s2_entropy
        mutual_information = self.mutual_information[sort_key][:, sort_key]
