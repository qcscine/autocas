...
class Elements:
    ...
    __slots__ = (
        "double_d_shell",
        "_double_d_shell_elements",
        "_element_list",
    )

    def __init__(self, double_d_shell: bool = Defaults.Molecule.double_d_shell):
        ...
        self._double_d_shell_elements: List[str] = [
            "Sc", "Ti", "V", "Cr", "Mn", "Fe", "Co", "Ni", "Cu", "Zn",
        ]
        """elements suited for double d shell option"""
        self._element_list: List[ElementDict] = [
            {
                "name": "H",
                "atomic number": 1,
        ...
        if self.double_d_shell:
            for element in self._element_list:
                if element.get("name") in self._double_d_shell_elements:
